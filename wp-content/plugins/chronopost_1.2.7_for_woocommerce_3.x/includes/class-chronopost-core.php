...
class Chronopost
{
    ...
    private function load_dependencies()
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/products/chronorelaisdom.php';
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-chronopost-cron.php';
        /**
