...
<section class="newsletter">
    <div class="container">
        ...
        <div class="flex">
            <div class="descr">
                <p>Abonnez- vous à notre newsletter pour recevoir nos offres en avant-première et toute notre actualité
                    ! Au
                ...
                <div class="shadowed-block">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <label class="single-toggle-label" for="tab1">Comment reconnaître un vin
                                biodynamique&nbsp;?</label>
                            <div class="single-toggle-content">
                                <p class="card-text">
                                    lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec euismod, nisi vel
                                    consectetur convallis, nisl nisi consectetur nisi, euismod consectetur nisi nisi
                                    velit.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <label class="single-toggle-label" for="tab2">Comment sont fabriqués les vin
                                biodynamiques&nbsp;?</label>
                            <div class="single-toggle-content">
                                <p class="card-text">
                                    lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec euismod, nisi vel
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="single-toggle-content">
                                <p class="card-text">
                                    Un vin vivant c’est un vin qui bouge, qui évolue, qui est, comme la nature, spontané
                                    et imprévisible. Un vin vivant est un vin naturel que l’on qualifie de vivant, ou de
                                    libre, parce que le vigneron le laisse s’exprimer sans ajouter d’intrants et de
                                    produits chimiques.
                                </p>
                            </div>
                        </div>
