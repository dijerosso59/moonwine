...
<section class="filter-product">
    <div class="container">
        <ul class="filter-nav">
            <li class="filter-nav_item">
                Couleur
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">Rouge</li>
                    <li class="filter-sous-menu_item">Blanc</li>
                    <li class="filter-sous-menu_item">Rose</li>
                    <li class="filter-sous-menu_item">Orange</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Type de vin
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">Doux</li>
                    <li class="filter-sous-menu_item">Moelleux</li>
                    <li class="filter-sous-menu_item">Sucré</li>
                    <li class="filter-sous-menu_item">Sec</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Pays
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">France</li>
                    <li class="filter-sous-menu_item">Espagne</li>
                    <li class="filter-sous-menu_item">Italie</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Région
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">...</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Occasion
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">Diner chic</li>
                    <li class="filter-sous-menu_item">Déjeuner</li>
                    <li class="filter-sous-menu_item">Barbecue</li>
                    <li class="filter-sous-menu_item">Plat principal</li>
                    <li class="filter-sous-menu_item">Entrée</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Artiste
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">Etienne FORT</li>
                    <li class="filter-sous-menu_item">Vitoria VILELA</li>
                </ul>
            </li>
            <li class="filter-nav_item">
                Trier par
                <ul class="filter-sous-menu">
                    <li class="filter-sous-menu_item">Nouveautés</li>
                    <li class="filter-sous-menu_item">Meilleures ventes</li>
                    <li class="filter-sous-menu_item">Prix croissant</li>
                    <li class="filter-sous-menu_item">Prix décroissant</li>
                </ul>
            </li>
        </ul>
    </div>
